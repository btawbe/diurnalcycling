...
function displayMetalsAroundLocation(locationName, metals) {
    ...
    .bindPopup(`
        <b>${metal}</b><br>
        <a href="/metalanalysis?season=AllSeason&year=AllYears&month=AllMonths&location=${encodeURIComponent(doii)}&mtlname=${encodeURIComponent(metal)}" target="_blank" style="color:blue; text-decoration:underline;">
