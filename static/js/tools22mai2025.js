...
function displayMetalsAroundLocation(locationName, metals) {
    ...
    .bindPopup(`
        <b>${metal}</b><br>
        <a href="/display?page=1&dropdown_season=AllSeason&dropdown_year=AllYears&dropdown_month=AllMonths&dropdown_location=${encodeURIComponent(metal)}" target="_blank" style="color:blue; text-decoration:underline;">
            Make an analysis for ${metal}
        </a>
    `)
     .bindTooltip(metal, {
